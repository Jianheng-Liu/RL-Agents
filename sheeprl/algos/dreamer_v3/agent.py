...
def build_agent(
    ...
    # Setup models to the device
    world_model.encoder.to(device)
    world_model.observation_model.to(device)
    world_model.reward_model.to(device)
    world_model.rssm.recurrent_model.to(device)
    world_model.rssm.representation_model.to(device)
    world_model.rssm.transition_model.to(device)
    if world_model.continue_model:
        world_model.continue_model.to(device)
    actor.to(device)
    critic.to(device)
    ...
    # Setup the player
    player.encoder.to(device)
    player.rssm.recurrent_model.to(device)
    player.rssm.transition_model.to(device)
    player.rssm.representation_model.to(device)
    player.actor.to(device)
